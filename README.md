# [AWS-MCQ](https://pritamkhose.github.io/AWS-MCQ)
...
Depoly the app for production to gh-pages.
...
# Create new project npm command
```
npx create-react-app AWS-MCQ --template typescript
